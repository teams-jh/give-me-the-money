...
import { calcSectorRotation } from "../src/library/shared/sector.ts";
import type { StockInput, SectorRotationResult } from "../src/library/shared/sector.ts";
...
function main(): void {
  ...
  const output = {
    ...
    sectorSeries: result.sectorSeries,
  };
