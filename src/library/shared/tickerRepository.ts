...
export function resolveMarketPaths(market: string, dbDir: string = DEFAULT_DB_DIR): MarketPaths | null {
...
export function loadTickerList(market: string, dbDir: string = DEFAULT_DB_DIR, n?: number): string[] {
...
export function loadTicker(market: string, ticker: string, dbDir: string = DEFAULT_DB_DIR): RawTicker | null {
  const paths = resolveMarketPaths(market, dbDir);
...
export function findSimilarTicker(market: string, bareTicker: string, dbDir: string = DEFAULT_DB_DIR): string | null {
